...
INPUT_RESULTS <- "C:/PDFs_extracted_text/extraction_results/nbs_extraction_results_grey_lit.rds"
...
2. Hydrology
3. Global Land Use and Land Cover 
...
# Save as RDS
saveRDS(harmonized_results, file.path(OUT_DIR, "nbs_harmonized_results_final_grey_lit.rds"))

# Save as CSV
write_excel_csv(harmonized_results, file.path(OUT_DIR, "nbs_harmonized_results_final_grey_lit.csv"))
